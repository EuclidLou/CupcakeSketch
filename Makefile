# Flags
CXXFLAGS := -Wall -Werror -Wno-reorder-ctor -Wno-unused-function -Wno-unused-variable -Wno-unused-private-field -Wno-register -Wno-c++11-narrowing -std=c++20 -fopenmp -mavx -mavx2
FFLAGS :=
BFLAGS := -d -v
LOGMODE :=
CXXFLAGS += $(MYFLAGS)
