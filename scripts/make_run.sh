...
compile_and_run() {
    ...
    # 根据宏定义编译项目
    make all MYFLAGS="-DCOSTUM -DUSE_TOWER=$USE_TOWER -DUSE_CS=$USE_CS -DMETRICS=$METRICS -DMEMORY_1_24=$MEMORY_1_24 -DK=$K -DDATASET='\"$DATASET\"' -DITEM_SIZE=$ITEM_SIZE -DREPEAT=$REPEAT -DS_FACTOR=$S_FACTOR -DSWAP_FACTOR=$SWAP_FACTOR -DHEAVY_BIAS=$HEAVY_BIAS -DTIMES_RESAMPLE=$TIMES_RESAMPLE" > /dev/null
...
for MEMORY_1_24 in $((256)) $((512)) $((1024)) $((2*1024)) $((4*1024)) $((8*1024)) $((16*1024)) $((32*1024)) $((64*1024)); do
